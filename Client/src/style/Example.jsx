...
const Example = () => {
  return (
    <div style={{zIndex: 0}} className="fixed top-0 left-0 h-screen w-screen flex flex-col items-center justify-center bg-[#0A0A0A]">
      <div className=" h-screen flex flex-col justify-center items-center">
        <div className="grid  h-screen w-screen absolute top-0 left-0">
          <svg
